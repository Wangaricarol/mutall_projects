...
class mutall {
    ...
    //
    //Every mutall object is characterized by this property
...
class database extends schema {
    ...
    public function authenticate(string $name, string $password): bool {
        ...
        if (count($users) > 1) {
            throw new myerror("More than one name found. "
...
abstract class entity extends schema implements expression {
    ...
    //friendly columns
    function get_friendly_part(join $join): \Generator {
        //
...
class table extends entity {
    ...
    function get_dependency(): ?int {
        ...
        $join = new \mutall\join($dependency->paths);
        //
...
class component {
    ...
    //
    //The at batch file for compiling at jobs
    const at_file = "crontab/mutall_atjobs.txt";
    //
    ...
    public function report_errors(array $errors) {
        ...
        foreach ($errors as $error) {
            ...
            $error_file = self::home . self::log_file;
            //
