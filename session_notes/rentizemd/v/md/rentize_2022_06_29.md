...
1.[ ]Make sure all the development is finished before handling the mutall_rental+ Outlook.  
...
##### Monthly invoicing (Json)query (7.3)

1.[ ] As a base for producing paper copies, emails and short sms.
