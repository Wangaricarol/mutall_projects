...
1. [ ]How do we collect the data that we require for all the interfaces that we implement.  
        ...
        1.3[ ]Create a php messenger class that takes care of sending the messeges for each
...
1. Write a twilio class to send messages in js(PK).  
        ...
        1.2 [ ] Address all the errors in your twilio class so we are left with ones that need further work.
