...
a.Show how the sms is working and how to send the message via android
       going beyond messaging and (JK)
    a.Install and test sending messages via android(JK)
    b.Investigate how we can put a spinner to show on the page(cw) 
    c.Make sure twilio is working for the group and the individual(FN)
...
2. [ ] Test the replying of messages  
3. [ ] Reply to a contribution message.(PK)  
