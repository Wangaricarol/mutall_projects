...
export class database{
	...
	constructor(
        ...
        //
        //This is the view from we lauched this metavisoo database
	...
	public draw(): void{
		...
		for(const ename in this.dbase.entities){
			//
			//Create the meta-viso entity
			const ent = new entity(ename, this);

			//Save the newly created entity to the metavisuo entities.
			this.entities[ename] = ent;
			//
        ...
        //
        //
        //Create the rellations and save them in this database 
	...
	create_relations():void{
		// 
		//For each metavisuo entity...
		for(const ename in this.dbase.entities){
			//
			//a. Get the named entity
			const entity:schema.entity = this.dbase.entities[ename];
			//
...
namespace marker{
    ...
    export class tick extends root{
        ...
        get_path():SVGLineElement{
            ...
            path_tick.setAttribute("d","M 8 8 l -2 16 h 1");
    ...
    class entity extends schema.entity {
        ...
        constructor(
            ...
            public name:string,
            //
            //The metavisuo database that houses this entity
            public metadbase:database,
            //
            ...
            const sentity:schema.Ientity = metadbase.dbase.static_dbase.entities[name];
            //
            //Construct the schema entity 
            super(metadbase.dbase, sentity);
            //
        ...
        draw():entity{
            ...
            //
            //Clear all the relationship drawn before on the canvas
            //
            //
            //Draw all the relationships from this entity

            //
            //Draw all the relationship from this entity
            //
            //Return this entity
            return this;
        }
        ...
        draw_circle():SVGCircleElement{
            ...
            this.metadbase.svg.appendChild(c);
            // 
        ...
        draw_group(circle:SVGCircleElement, labels:SVGElement, text:SVGTextElement):SVGGraphicsElement{
            ...
            this.metadbase.svg.appendChild(group);
            //
        ...
        draw_text(name:string,centerx:number,centery:number):SVGTextElement{
            ...
            this.metadbase.svg.appendChild(text);
            // 
        ...
        draw_attributes():SVGElement{
            ...
            this.metadbase.svg.appendChild(gattr);
            // 
        ...
        select(){
            ...
            const previous:HTMLElement|null = this.metadbase.svg.querySelector('.selected');
            //
        ...
        move(position:DOMPoint):void{
            ...
            this.metadbase.svg.removeChild(this.element!); 
            //
            ...
            //
            //Clear all relations
            this.metadbase.relations.forEach(Relation=>Relation.clear());
            //
            //Draw all relations
            this.metadbase.relations.forEach(Relation=>Relation.draw());
            //
    ...
    class relation{
        ...
        public dest:entity;
        // 
        //The olyline that represnts this relationhip
        ...
        draw():void{
            ...
            // 
            //Attach the polyline to the svg element
            this.src.metadbase.svg.appendChild(polyline);
            // 
        ...
        clear():void{
            //
            this.src.metadbase.svg.removeChild(this.polyline!);
        }
