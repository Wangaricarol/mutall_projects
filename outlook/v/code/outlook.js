...
export class page extends view {
    ...
    create_business_selector() {
        //
        //Get the section
        const section = this.get_element("business");
        //
    ...
    fill_date(id) {
        ...
        const date = today.match(/(\d{4})-(\d{1,2})-(\d{1,2})/g)[0];
        //
