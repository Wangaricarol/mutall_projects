...
class tree_view extends node_view{
    ...
    static get_tree_view_elements(node:node):{
        root:HTMLElement, 
        ...
        const hook:HTMLElement = (node.parent===undefined) ? node.explorer.panel.tree!: node.parent.tree.children;
        //
    ...
    private static add_attributes(explorer:explorer, properties:properties, selector:HTMLElement):void{
        //
    ...
    */
    ...
    //the header
    static create_selection_element(node:node, anchor:HTMLElement):HTMLElement{
        //
...
class node{
    ...
    private async paint_in_tree_view?():Promise<void>{
        //
...
export class explorer extends outlook.baby<selection|undefined>{
    //
    //The root node
    public root?:node;
    //
    ...
    async get_result():Promise<selection|undefined>{
        //
...
export namespace record {
    ...
    export class root extends content{
        ...
        constructor(subject:subject, fname:string){
            //
    ...
    class child extends content{
        ...
        constructor(
            ...
            const name:string = String(fuel[fname]);
            //
