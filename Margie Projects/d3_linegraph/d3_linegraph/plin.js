...
//     //create the x axis
    ...
    //
    var x = d3.scaleTime()
    //The d3.extent()gets the min and max value of the siku data using in order
    //
    //The d3.domain()an array of integers that is defining the extent of siku values.
    ...
    .attr("d", d3.line()
    //Provide the x coordinate of the data point siku
        .x((d)=>{return x(d.siku)})
    //Provide the y coordinate of the data point rate
        .y((d)=>{return y(d.rate)}));
    //
